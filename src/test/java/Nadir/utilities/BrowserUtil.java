...
//   • Arg3: String expectedTitle
    ...
    public static void switchWindowAndVerify(String expectedInUrl,String expectedTitle){
        ...
        Set<String> allWindowHandles = com.cydeo.utilities.Driver.getDriver().getWindowHandles();

        for (String eachWindow : allWindowHandles) {
            // driver.switchTo().window(eachWindow); syntax will switch each windows and driver will be able to see each window
            com.cydeo.utilities.Driver.getDriver().switchTo().window(eachWindow);
...
//        5. Assert:Title contains “Etsy”
    ...
    public static void waitForInvisibilityOf(WebElement element){
        ...
        WebDriverWait wait = new WebDriverWait(com.cydeo.utilities.Driver.getDriver(),10);
    ...
    public static void verifyElementDisplayed(By by) {
        try {
            Assert.assertTrue (  com.cydeo.utilities.Driver.getDriver().findElement(by).isDisplayed(), "Element not visible: " + by);
    ...
    public static void verifyElementNotDisplayed(By by) {
        try {
            Assert.assertFalse( com.cydeo.utilities.Driver.getDriver().findElement(by).isDisplayed(),"Element should not be visible: " + by);
        } catch (NoSuchElementException e) {
            e.printStackTrace();
